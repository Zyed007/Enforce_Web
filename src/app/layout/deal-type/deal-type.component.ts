...
public onAddSubmit(){
  ...
  let postData={
    ...
    deal_type_name: this.statusForm.get('statusName').value  ,
    deal_type_desc: this.statusForm.get('desc').value,
...
this.assigneeData =results;
    ...
    this.dataSource=ds1.dataSource['json'];
            ...
            (data:any)  => {
             ...
             let postData={
              ...
              this.statusForm.setValue({
                ...
                statusName: data.deal_type_name,
                desc:data.deal_type_desc,
        ...
        public onEditSubmit(){
          ...
          let postData={
            ...
            if (this.statusForm.status== 'VALID') {              
                  ...
                  return this.leadService.UpdateLeadDealType(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.leadService.RemoveLeadDealType(postData).subscribe(
            (data:any)  => {
