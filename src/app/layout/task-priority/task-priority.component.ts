...
public onAddSubmit(){
  ...
  let postData={
    ...
    if(this.priorityForm.status=='VALID'){
    ...
    public  getAllPriority(){
      this.taskService.getAllPriority().subscribe(
        ...
        this.showAddForm=true;
          ...
          this.taskService.getByPriorityID(postData).subscribe(
            (data:any)  => {
        ...
        public onEditSubmit(){
          ...
          let postData={
            ...
            this.addformSubmit=false;
                  ...
                  return this.taskService.updatePriority(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.taskService.delPriority(postData).subscribe(
            (data:any)  => {
              // let dataObj = JSON.parse(data['token']);
