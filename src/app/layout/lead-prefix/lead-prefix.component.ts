...
@Component({
  selector: 'app-lead-prefix',
  templateUrl: './lead-prefix.component.html',
  styleUrls: ['./lead-prefix.component.scss']
})

export class LeadPrefixComponent implements OnInit {
...
this.txtMsg="Eg: ENQ/20/08/0000,ENQ/20/08/0001"
...
this.txtMsg="User is allowed to enter custom prefix"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: ENQ/0000,ENQ/0001"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: ENQ/5454,ENQ/8984"
