       ...
       this.showOrgDetails=false;
        ...
        onPrimaryContactCheck(e){
         ...
         this.leadCustomerForm.patchValue({
          ...
          phone:this.leadCustomerForm.get('customer_phone').value!=''?this.leadCustomerForm.get('customer_phone').value:'',
...
this.projectForm.patchValue({
 ...
 this.customerContactForm = new FormGroup({
  ...
  this.leadCustomerForm = new FormGroup({
    ...
    lname: new FormControl('',[Validators.required]),
    position: new FormControl(''),
    phone: new FormControl('',[Validators.required,patternValidator(/^\+\d{1,3}-\d{9,10}$/)]),
    mobile: new FormControl(''),
    email: new FormControl('',[Validators.required,Validators.pattern(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)]),
    relationship: new FormControl(''),
    designation: new FormControl(''),
