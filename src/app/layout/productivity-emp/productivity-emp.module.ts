...
import { ProductivityEmpRoutingModule } from './productivity-emp-routing.module';
...
@NgModule({
    imports: [
        CommonModule,MatGridListModule,MatCardModule,NotFoundModule,
        ...
        ProductivityEmpRoutingModule,GridAllModule,Select2Module,ChartAllModule,AccumulationChartAllModule, RangeNavigatorAllModule,
