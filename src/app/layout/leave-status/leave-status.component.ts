...
public onAddSubmit(){
  ...
  let postData={
    ...
    "leave_status_name":  this.statusForm.get('statusName').value  ,
    "leave_status_desc":  this.statusForm.get('desc').value  ,
     ...
     if(this.statusForm.status=='VALID'){
      return this.leaveService.AddLeaveStatus(postData).subscribe(
        (data:any)  => {
...
//.dataSource=ds1.dataSource['json'];
        ...
        this.EmpList();
          ...
          this.leaveService.FindByLeaveStatusID(postData).subscribe(
            (data:any)  => {
             
            
              this.statusForm.patchValue({
           
                statusName: data.leave_status_name,
                desc:data.leave_status_desc,
    ...
    "leave_status_desc":  this.statusForm.get('desc').value  ,
              ...
              if (this.statusForm.status== 'VALID') {
                  ...
                  return this.leaveService.UpdateLeaveStatus(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
      ...
      this.TaskView();
        ...
        public taskDelete(deptId){
          ...
          this.leaveService.RemoveLeaveStatus(postData).subscribe(
            (data:any)  => {
