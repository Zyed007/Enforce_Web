...
@Component({
    ...
    styleUrls: ['./footer.component.scss'],providers: [{ provide: BsDropdownConfig, useValue: { isAnimated: true, autoClose: true } }]
})
export class FooterComponent implements OnInit {
    ...
    constructor(private translate: TranslateService,public orgService:OrganizationService, public router: Router) {
