...
@Component({
  selector: 'app-emp-team-setup',
  templateUrl: './emp-team-setup.component.html',
  styleUrls: ['./emp-team-setup.component.scss'],
  encapsulation: ViewEncapsulation.None, 
  providers: [DayService, WeekService, WorkWeekService, MonthService, AgendaService],
})

export class EmpTeamSetupComponent implements OnInit {
              ...
              //  this.searchOptions = { fields: ['dep_name'], operator: 'contains', key: 'Ha', ignoreCase: true };
                ...
                public tabSelected(args: SelectEventArgs): void {
                  ...
                  if(args.selectedItem.innerText=="ALL EMPLOYEES"){
                    ...
                    this.showEmp=false;
                    this.showDeptMem=false;
                    this.WorkforceProductiveByOrgIDAndDate(this.teamValue)
                  ...
                  this.activityService.WorkforceProductiveByOrgIDAndDate(postData).subscribe(
                    (data:any)  => {
                      if(data){
                        ...
                        this.prodPercent=data.total_productive_percent;
                        this.showTimeSpinner=false;
