...
import { EmpTeamSetupRoutingModule } from './emp-team-setup-routing.module';
...
@NgModule({
    imports: [
        ...
        EmpTeamSetupRoutingModule,GridAllModule,Select2Module,ChartAllModule,AccumulationChartAllModule, RangeNavigatorAllModule,
