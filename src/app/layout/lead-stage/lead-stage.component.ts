...
public onAddSubmit(){
  ...
  let postData={
    ...
    stage_name: this.statusForm.get('statusName').value  ,
    stage_desc: this.statusForm.get('desc').value,
    ...
    if (this.statusForm.status== 'VALID') {
        return this.leadService.AddLeadStage(postData).subscribe(
          (data:any)  => {
...
this.assigneeData =results;
    ...
    this.dataSource=ds1.dataSource['json'];
        ...
        this.showAddForm=true;
          ...
          this.leadService.FindByLeadStageId(postData).subscribe(
            (data:any)  => {
             ...
             let postData={
              ...
              this.statusForm.setValue({
                ...
                statusName: data.stage_name,
                desc:data.stage_desc,
        ...
        public onEditSubmit(){
          ...
          let postData={
            ...
            if (this.statusForm.status== 'VALID') {              
                  ...
                  return this.leadService.UpdateLeadStage(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.leadService.RemoveLeadStage(postData).subscribe(
            (data:any)  => {
