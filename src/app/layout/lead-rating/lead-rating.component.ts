...
@Component({
  ...
  styleUrls: ['./lead-rating.component.scss']
})
...
export class LeadRatingComponent implements OnInit {
  ...
  pageSize: any = 10;
  currentPage: any = 1;
  constructor(public taskService:TaskService,private leadService: LeadService,private toastr: ToastrService,private leaveService:LeaveService,  private formBuilder: FormBuilder,public empService:EmployeeService,
    ) {
    this.taskPriority = '0';
    this.taskStatus = '0';
...
public onAddSubmit(){
  ...
  let postData={
    ...
    rating_name: this.statusForm.get('statusName').value  ,
    rating_desc: this.statusForm.get('desc').value,
        ...
        return this.leadService.AddLeadRating(postData).subscribe(
          (data:any)  => {
...
//.dataSource=ds1.dataSource['json'];
        ...
        this.showAddForm=true;
          ...
          this.leadService.FindByLeadRatingByID(postData).subscribe(
            (data:any)  => {


              this.statusForm.patchValue({

                statusName: data.rating_name,
                desc:data.rating_desc,
          ...
          let postData={
            ...
            rating_desc: this.statusForm.get('desc').value,
              ...
              if (this.statusForm.get('statusName').value !== '') {
                  ...
                  return this.leadService.UpdateLeadRating(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.leadService.RemoveLeadRating(postData).subscribe(
            (data:any)  => {
