...
@Component({
  selector: 'app-milestone-template',
  templateUrl: './milestone-template.component.html',
  styleUrls: ['./milestone-template.component.scss']
})
export class MilestoneTemplateComponent implements OnInit {
    ...
    public  getAllEmpStatus(){
      this.empService.getAllEmpStatus().subscribe(
        ...
        public taskDelete(deptId){
          ...
          this.templateService.RemoveMilestoneTemplateByID(postData).subscribe(
            (data:any)  => {
          ...
          public  GetEmployeeStatusByOrgID(){
            this.templateService.FindMilestoneTemplatesByOrgID().subscribe(
