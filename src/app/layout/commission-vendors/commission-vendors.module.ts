...
import { CommissionVendorsRoutingModule } from './commission-vendors-routing.module';
...
@NgModule({
    ...
    declarations: [
      CommissionVendorsComponent
    ]
})
export class CommissionVendorsModule {}
