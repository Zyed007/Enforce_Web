...
@Component({
  ...
  styleUrls: ['./activities-admin.component.scss'],
...
if(localStorage.getItem('ActivityEmpID')){
  ...
  teamEmpId=''
      ...
      // this.spinner.hide();
        ...
        this.prodRatio=data.productivity_ratio.toString().length==1?data.productivity_ratio:parseFloat(data.productivity_ratio).toFixed(2);
...
// }
         ...
         public toProjList(){
            ...
            public taskDelete(deptId){
              ...
              openEmpVieModal(type){
                $('#emp_view_modal').modal('show');
                this.toolbar = ['Search'];
                if(type=='most_productive'){
                  this.empTypeData=this.most_productive
                  this.typeOfHeader='Most Productive'

                }else if(type=='most_unproductive'){
                  this.empTypeData=this.most_unproductive
                  this.typeOfHeader='Most Unproductive'


                }else if(type=='most_effective'){
                  this.empTypeData=this.most_effective
                  this.typeOfHeader='Most Effective'


                }else if(type=='most_idle_time'){
                  this.empTypeData=this.most_idle_time
                  this.typeOfHeader='Most Offline Time Logged'


                }else if(type=='most_late_emp'){
                  this.empTypeData=this.most_late_emp
                  this.typeOfHeader='Late'


                }else if(type=='absence'){
                  this.empTypeData=this.absence
                  this.typeOfHeader='Absence'
              ...
              this.data12=datas.dataSource['json']
                ...
                toActivitiesEmp(emp_id){
                  this.router.navigate(['/activities-emp']);
                  localStorage.setItem('ActivityEmpID',emp_id)
                }
  ...
  // .data([this.testDataRelative]).call(chart);
      ...
      closeDetailsViewModal(){
        ...
        ProductiveByOrgIDAndDate(id){
          ...
          this.activityService.ProductiveByOrgIDAndDate(postData).subscribe(
            (data:any)  => {
             if(data){
               this.showTimeSpinner=false;
               this.spinner.hide();
              this.activity_count=data.activities_count
              // this.prodTime=data.productive_time
              this.arrivedCount=data.arrived_count
        this.prodRatio=data.productive_percent.toString().length==1?data.productive_percent:parseFloat(data.productive_percent).toFixed(2);

              this.lateCount=data.late_count
              this.absentCount=data.absent_count
              if(data.most_productive){
                this.most_productive=data.most_productive
                for(var i=0;i<data.most_productive.length;i++){
                  if(data.most_productive[i].available_hour!=null){
                    let timeSpentString=data.most_productive[i].available_hour.split(':');
                    this.most_productive[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_productive[i].available_hour=('0 h 0 m');

                  }
                  if(data.most_productive[i].productive_percent!=null){

                    this.most_productive[i].productive_percent=this.most_productive[i].productive_percent.toString().length==1?this.most_productive[i].productive_percent:parseFloat(this.most_productive[i].productive_percent).toFixed(2);
                  }else{
                    this.most_productive[i].productive_percent=0;

                  }

                  if(data.most_productive[i].worked_hour!=null){
                    let timeSpentString=data.most_productive[i].worked_hour.split(':');
                    this.most_productive[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_productive[i].worked_hour=('0 h 0 m');

                  }
                }
              }
              if(data.most_unproductive){
                this.most_unproductive=data.most_unproductive
                for(var i=0;i<data.most_unproductive.length;i++){
                  if(data.most_unproductive[i].available_hour!=null){
                    let timeSpentString=data.most_unproductive[i].available_hour.split(':');
                    this.most_unproductive[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_unproductive[i].available_hour=('0 h 0 m');

                  }
                  if(data.most_unproductive[i].productive_percent!=null){

                    this.most_unproductive[i].productive_percent=this.most_unproductive[i].productive_percent.toString().length==1?this.most_unproductive[i].productive_percent:parseFloat(this.most_unproductive[i].productive_percent).toFixed(2);
                  }else{
                    this.most_unproductive[i].productive_percent=0;

                  }
                  if(data.most_unproductive[i].worked_hour!=null){
                    let timeSpentString=data.most_unproductive[i].worked_hour.split(':');
                    this.most_unproductive[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_unproductive[i].worked_hour=('0 h 0 m');

                  }
                }
              }
              if(data.most_effective){
                this.most_effective=data.most_effective
                for(var i=0;i<data.most_effective.length;i++){
                  if(data.most_effective[i].available_hour!=null){
                    let timeSpentString=data.most_effective[i].available_hour.split(':');
                    this.most_effective[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_effective[i].available_hour=('0 h 0 m');

                  }
                  if(data.most_effective[i].productive_percent!=null){

                    this.most_effective[i].productive_percent=this.most_effective[i].productive_percent.toString().length==1?this.most_effective[i].productive_percent:parseFloat(this.most_effective[i].productive_percent).toFixed(2);
                  }else{
                    this.most_effective[i].productive_percent=0;

                  }
                  if(data.most_effective[i].worked_hour!=null){
                    let timeSpentString=data.most_effective[i].worked_hour.split(':');
                    this.most_effective[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_effective[i].worked_hour=('0 h 0 m');

                  }
                }
              }
                 if(data.most_idle_time){
                this.most_idle_time=data.most_idle_time
                for(var i=0;i<data.most_idle_time.length;i++){
                  if(data.most_idle_time[i].available_hour!=null){
                    let timeSpentString=data.most_idle_time[i].available_hour.split(':');
                    this.most_idle_time[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_idle_time[i].available_hour=('0 h 0 m');

                  }
                  if(data.most_idle_time[i].worked_hour!=null){
                    let timeSpentString=data.most_idle_time[i].worked_hour.split(':');
                    this.most_idle_time[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_idle_time[i].worked_hour=('0 h 0 m');

                  }
                }
              }
              if(data.most_late_emp){
                this.most_late_emp=data.most_late_emp
                for(var i=0;i<data.most_late_emp.length;i++){
                  if(data.most_late_emp[i].available_hour!=null){
                    let timeSpentString=data.most_late_emp[i].available_hour.split(':');
                    this.most_late_emp[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.most_late_emp[i].available_hour=('0 h 0 m');

                  }
                  // if(data.most_late_emp[i].worked_hour!=null){
                  //   let timeSpentString=data.most_late_emp[i].worked_hour.split(':');
                  //   this.most_late_emp[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  // }else{
                  //   this.most_late_emp[i].worked_hour=('0 h 0 m');
              ...
              if(data.absence){
                ...
                for(var i=0;i<data.absence.length;i++){
                  if(data.absence[i].available_hour!=null){
                    let timeSpentString=data.absence[i].available_hour.split(':');
                    this.absence[i].available_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.absence[i].available_hour=('0 h 0 m');

                  }
                  if(data.absence[i].worked_hour!=null){
                    let timeSpentString=data.absence[i].worked_hour.split(':');
                    this.absence[i].worked_hour=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
                  }else{
                    this.absence[i].worked_hour=('0 h 0 m');

                  }
                }
              }
              if(data.productive_time!=null){
                let timeSpentString=data.productive_time.split(':');
                // this.time_spend=(timeSpentString[0] +' h ') +(timeSpentString[1] +' m ');
              this.time_spend=(timeSpentString[0]=="00"?'0 h ':(timeSpentString[0] +' h ')) +(timeSpentString[1]=="00"?'0 m':(timeSpentString[1] +' m '));
              this.prodTime=this.time_spend;
        ...
        ProductiveByDeptIDAndDate(id){
          ...
          this.activityService.ProductiveByDeptIDAndDate(postData).subscribe(
            (data:any)  => {
             if(data){
               this.showTimeSpinner=false;
               this.spinner.hide();
        ...
        ProductivityGraphByOrgIDAndDate(id)  {
          let postData={
            "id": id,
            "date": this.dateSelect
          ...
          this.showTimeSpinner=true;
          this.activityService.ProductivityGraphByOrgIDAndDate(postData).subscribe(
            (data:any)  => {
       let prodData=[]
       let idleData=[]
       let ondate;
...
//  StartTime.getHours(), StartTime.getMinutes(), StartTime.getSeconds()),null);
        ...
        ProductiveGraphByTeamIDAndDate(id)  {
          let postData={
            "id": id,
            "date": this.dateSelect
          ...
          this.activityService.ProductiveGraphByTeamIDAndDate(postData).subscribe(
            (data:any)  => {
              let prodData=[]
              let idleData=[]
              let ondate;
       ...
       //  StartTime.getHours(), StartTime.getMinutes(), StartTime.getSeconds()),null);
        ...
        ProductiveGraphByDeptIDAndDate(id)  {
          let postData={
            "id": id,
            "date": this.dateSelect
          ...
          this.activityService.ProductiveGraphByDeptIDAndDate(postData).subscribe(
            (data:any)  => {
              let prodData=[]
              let idleData=[]
              let ondate;
       ...
       //  StartTime.getHours(), StartTime.getMinutes(), StartTime.getSeconds()),null);
        ...
        ProductiveByTeamIDAndDate(id){
          ...
          this.activityService.ProductiveByTeamIDAndDate(postData).subscribe(
            (data:any)  => {
             if(data){
               this.showTimeSpinner=false;
               this.spinner.hide();
  ...
  this.dateSelect=moment(this.today).format('L');
