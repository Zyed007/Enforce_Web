...
import { recieptSettingRoutingModule } from './reciept-routing.module';
...
@NgModule({
    imports: [
        ...
        UploaderModule,
        RadioButtonModule,
        recieptSettingRoutingModule,
        DatePickerModule,
        DateRangePickerModule
    ],
    declarations: [
        RecieptSettingComponent,
        RecieptPrefixComponent
    ]
})
export class recieptSettingModule { }
