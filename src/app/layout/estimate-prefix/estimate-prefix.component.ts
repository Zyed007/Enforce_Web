...
@Component({
  selector: 'app-estimate-prefix',
  templateUrl: './estimate-prefix.component.html',
  styleUrls: ['./estimate-prefix.component.scss']
})



export class EstimatePrefixComponent implements OnInit {
...
this.txtMsg="Eg: EST/20/08/0000,EST/20/08/0001"
...
this.txtMsg="User is allowed to enter custom prefix"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: EST/0000,EST/0001"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: EST/5454,EST/8984"
