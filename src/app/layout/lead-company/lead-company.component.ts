...
@Component({
  selector: 'app-lead-company',
  templateUrl: './lead-company.component.html',
  styleUrls: ['./lead-company.component.scss']
})
...
public onAddSubmit(){
  ...
  let postData={
    ...
    company_name: this.statusForm.get('statusName').value  ,
    comapany_desc: this.statusForm.get('desc').value,
...
//.dataSource=ds1.dataSource['json'];
        ...
        this.showAddForm=true;
          ...
          this.leadService.FindByLeadCompanyByID(postData).subscribe(
            (data:any)  => {


              this.statusForm.patchValue({

                statusName: data.company_name,
                desc:data.comapany_desc,
          ...
          let postData={
            ...
            comapany_desc: this.statusForm.get('desc').value,
              ...
              if (this.statusForm.get('statusName').value !== '') {
                  ...
                  return this.leadService.UpdateLeadCompany(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.leadService.RemoveLeadCompany(postData).subscribe(
            (data:any)  => {
