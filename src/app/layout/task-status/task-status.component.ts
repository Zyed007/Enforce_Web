...
public onAddSubmit(){
  ...
  let postData={
    ...
    this.addformSubmit=false;
        ...
        return this.taskService.AddStatus(postData).subscribe(
          (data:any)  => {
...
this.assigneeData =results;
    ...
    public  getAllTaskStatus(){
      this.taskService.getAllTaskStatus().subscribe(
        ...
        this.showAddForm=true;
          ...
          this.taskService.getByStatusID(postData).subscribe(
            (data:any)  => {
    ...
    this.addformSubmit=false;
                  ...
                  return this.taskService.updateStatus(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.taskService.delTaskStatus(postData).subscribe(
            (data:any)  => {
