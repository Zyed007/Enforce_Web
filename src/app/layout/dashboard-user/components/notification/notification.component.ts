...
import { ParentComponentApi } from '../../dashboard-user.component';
...
export class NotificationComponent implements OnInit {
 ...
 args.popup.offsetX=0;
  ...
  // team_member_empid.push(user_info['id'])
    let postData={
      id:this.arrayContains?this.taskForm.get('taskName').value[0]['value']:null,
    
    task_name:(this.taskForm.get('taskName').value!='' && this.taskForm.get('taskName').value!=null)?this.taskForm.get('taskName').value[0]['display']:null,
    //sub_task_name:(this.taskLogForm.get('subtaskName').value!='' && this.taskLogForm.get('subtaskName').value!=null)?this.taskLogForm.get('subtaskName').value[0]['display']:null,
      ...
      project_id: (this.linkToProj && this.projid!='')?this.projid:null,
      activtity_id: (this.linkToProj && this.acttaskListValue!='')?this.acttaskListValue:null,   
     // task_name:(this.linkToProj?this.taskInputText:this.taskForm.get('taskName').value )  ,
      sub_task_name:this.taskForm.get('subtaskName').value!=''?this.taskForm.get('subtaskName').value:null,
