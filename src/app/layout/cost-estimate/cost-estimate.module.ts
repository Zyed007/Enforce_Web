...
import { CostEstimateRoutingModule } from './cost-estimate-routing.module';
...
@NgModule({
    imports: [CommonModule,PagerModule,NotFoundModule,NgxMaterialTimepickerModule,UploaderModule,NgxFormatFieldModule,NumericTextBoxModule,CostEstimateRoutingModule,NgbModule,AccordionModule,TagInputModule,MultiSelectModule,
        ...
        MatSortModule,Select2Module,FormsModule, ReactiveFormsModule,ButtonModule, CheckBoxModule, RadioButtonModule, DropDownButtonModule, SplitButtonModule, SwitchModule, ProgressButtonModule,
        AgmCoreModule.forRoot({
            apiKey: GlobalConstants.apiKey,
            libraries: ['places']
          })
        ],
    declarations: [CostEstimateComponent, NotificationComponent]
})
