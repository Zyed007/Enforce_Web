...
@Component({
  selector: 'app-qtn-prefix',
  templateUrl: './qtn-prefix.component.html',
  styleUrls: ['./qtn-prefix.component.scss']
})


export class QtnPrefixComponent implements OnInit {
...
this.txtMsg="Eg: QTN/20/08/0000,QTN/20/08/0001"
...
this.txtMsg="User is allowed to enter custom prefix"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: QTN/0000,QTN/0001"
   ...
   this.inputDisabled=false;
   this.txtMsg="Eg: QTN/5454,QTN/8984"
