...
@Component({
  selector: 'app-radius-setup',
  templateUrl: './radius-setup.component.html',
  styleUrls: ['./radius-setup.component.scss']
})

export class RadiusSetupComponent implements OnInit {
...
// team_member_empid.push(user_info['id'])
    ...
    let postData={
      "profit_margin": this.taskForm.get('taskName').value,
    }
...
if(this.taskForm.status=='VALID'){
  ...
  this.spinner.show();
        return this.costService.AddProfitMargin(postData).subscribe(
          (data:any)  => {
            // let dataObj = JSON.parse(data['token']);
    ...
    profit_margin: this.taskForm.get('taskName').value,
      ...
      if(this.taskForm.get('taskName').value!='' ){
        this.spinner.show();
          ...
          return this.costService.UpdateProfitMargin(postData).subscribe(
            (data:any)  => {
              // let dataObj = JSON.parse(data['token']);
    ...
    public  getAllTask(){
      this.taskService.getAllTask().subscribe(
       ...
       ;
          ...
          this.costService.FindByProfitMarginID(postData).subscribe(
            (data:any)  => {


              this.taskForm.patchValue({

                taskName: data.profit_margin,
