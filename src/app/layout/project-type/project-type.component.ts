...
export class ProjectTypeComponent implements OnInit {
  ...
  constructor(public taskService:TaskService,private spinner:NgxSpinnerService, public projectService:ProjectService,private toastr: ToastrService,  private formBuilder: FormBuilder,public empService:EmployeeService,
    ) { 
    this.taskPriority = '0';
    this.taskStatus = '0';
...
public onAddSubmit(){
  ...
  let postData={
    ...
    type_name: this.statusForm.get('statusName').value  ,
    type_desc: this.statusForm.get('desc').value,
    ...
    public  getAllTaskStatus(){
      this.taskService.getAllTaskStatus().subscribe(
        ...
        this.showAddForm=true;
          ...
          this.projectService.FindByProjectTypeID(postData).subscribe(
            (data:any)  => {
             

              this.statusForm.setValue({
           
                statusName: data.type_name,
                desc:data.type_desc,
...
this.spinner.show();
                  ...
                  return this.projectService.UpdateProjectType(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
...
this.spinner.show();
          ...
          this.projectService.RemoveProjectType(postData).subscribe(
            (data:any)  => {
