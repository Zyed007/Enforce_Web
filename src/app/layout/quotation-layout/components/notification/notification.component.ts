...
import { ParentComponentApi } from '../../quotation-layout.component';
...
export class NotificationComponent implements OnInit {
  ...
  let postData={
    id:null,
    project_id: sessionStorage.getItem('qtnId'),
    activtity_id: null,
  ...
  if(this.taskForm.status=='VALID' && (this.isApprove?this.approverTaskValue!=='':true) && this.assigneeStatus.length!=0 ){
          ...
          return this.projectService.AddProjTask(postData).subscribe(
           ...
           if(data){
            ...
            event_type: "estimation task added",
            event_desc: "estimation task added successfully",
           };
        ...
        if (this.taskForm.get('taskName').value !== '') {
            ...
            return this.projectService.UpdateTask(postData).subscribe(
             ...
             if(data){
              ...
              event_type: "estimation task edited",
              event_desc: "estimation task edited successfully",
             };
             this.histSer.AddEntityHistoryLog(postData).subscribe((data)=> {
                  console.log(data)
              });
