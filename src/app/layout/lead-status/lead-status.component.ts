...
public onAddSubmit(){
  ...
  let postData={
    ...
    lead_status: this.statusForm.get('statusName').value  ,
    lead_status_desc: this.statusForm.get('desc').value,
    ...
    if (this.statusForm.status== 'VALID') {
        ...
        return this.leadService.AddLeadStatus(postData).subscribe(
          (data:any)  => {
...
//.dataSource=ds1.dataSource['json'];
        ...
        this.showAddForm=true;
          ...
          this.leadService.FindByLeadStatusByID(postData).subscribe(
            (data:any)  => {
             
             
              this.statusForm.patchValue({
           
                statusName: data.lead_status,
                desc:data.lead_status_desc,
        ...
        public onEditSubmit(){
          ...
          let postData={
            ...
            if (this.statusForm.status== 'VALID') {              
                  ...
                  return this.leadService.UpdateLeadStatus(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.leadService.RemoveLeadStatus(postData).subscribe(
            (data:any)  => {
