...
export class ReasonTypeComponent implements OnInit {
  ...
  constructor(public taskService:TaskService,private spinner:NgxSpinnerService, public projectService:ProjectService, public leaveService:LeaveService,private toastr: ToastrService,  private formBuilder: FormBuilder,public empService:EmployeeService,
    ) {
    this.taskPriority = '0';
    this.taskStatus = '0';
...
public onAddSubmit(){
  ...
  let postData={
    ...
    reasons_name: this.statusForm.get('statusName').value  ,
    reasons_desc: this.statusForm.get('desc').value,
...
this.spinner.show();
        ...
        return this.leaveService.AddReasons(postData).subscribe(
          (data:any)  => {
    ...
    public  getAllTaskStatus(){
      this.taskService.getAllTaskStatus().subscribe(
        ...
        this.showAddForm=true;
          ...
          this.leaveService.FindByReasonsID(postData).subscribe(
            (data:any)  => {


              this.statusForm.setValue({

                statusName: data.reasons_name,
                desc:data.reasons_desc,
...
this.spinner.show();
                  ...
                  return this.leaveService.UpdateReasons(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
...
this.spinner.show();
          ...
          this.leaveService.RemoveReasons(postData).subscribe(
            (data:any)  => {
