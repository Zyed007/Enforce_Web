...
@Component({
  selector: 'app-cost-type-design',
  templateUrl: './cost-type-design.component.html',
  styleUrls: ['./cost-type-design.component.scss']
})


export class CostTypeDesignComponent implements OnInit {
