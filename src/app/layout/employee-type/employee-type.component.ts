...
public onAddSubmit(){
  ...
  let postData={
    ...
    this.addformSubmit=false;
        return this.empService.AddEmployeeType(postData).subscribe(
          (data:any)  => {
...
this.assigneeData =results;
    ...
    this.dataSource=ds1.dataSource['json'];
        ...
        this.showAddForm=true;
          ...
          this.empService.getByEmpTypeID(postData).subscribe(
            (data:any)  => {
             ...
             let postData={
              ...
              this.statusForm.setValue({
                ...
                statusName: data.employee_type_name,
                desc:data.employee_type_desc,
        ...
        public onEditSubmit(){
          ...
          let postData={
            ...
            this.addformSubmit=false;
                  ...
                  return this.empService.updateEmpType(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.empService.delEmpType(postData).subscribe(
            (data:any)  => {
