...
this.showMonthsContainer=false;
 ...
 if(this.selectedTabText=='ALL EMPLOYEES'){
  ...
  this.WorkforceProductiveByDeptIDAndDate(this.selectedDeptId)
        ...
        sessionStorage.setItem('workforceDate',JSON.stringify(this.selectedDate));
         ...
         public toProjList(){
            ...
            public taskDelete(deptId){
              ...
              //  this.searchOptions = { fields: ['dep_name'], operator: 'contains', key: 'Ha', ignoreCase: true };
                ...
                public WorkforceProductiveByOrgIDAndDate(teamid){
                  let postData={
                    id:teamid,
                    date:this.dateSelect
                  }
this.spinner.show();
                  this.activityService.WorkforceProductiveByOrgIDAndDate(postData).subscribe(
                    (data:any)  => {
                      if(data){
                        this.spinner.hide();
              ...
              this.data12=datas.dataSource['json']
                ...
                public WorkforceProductiveByTeamIDAndDate(teamid){
                  let postData={
                    id:teamid,
                    date:this.dateSelect
                  }

                  this.activityService.WorkforceProductiveByTeamIDAndDate(postData).subscribe(
                    (data:any)  => {
                      if(data){
                        this.spinner.hide();
                        this.teamMembers=data.team_members;
              ...
              this.teamEmployeeWorkforce=empWfData;
                ...
                public WorkforceProductiveByDeptIDAndDate(teamid){
                  let postData={
                    id:teamid,
                    date:this.dateSelect
                  }

                  this.activityService.WorkforceProductiveByDeptIDAndDate(postData).subscribe(
                    (data:any)  => {
                      if(data){
                        this.spinner.hide();
              ...
              // this.data12=datas.dataSource['json']
                ...
                public changedTeam(e: any): void {
                  ...
                  if(e.value!='' &&e.value!='Select' ){
                    ...
                    this.WorkforceProductiveByTeamIDAndDate(e.value);
