...
@Pipe({
 ...
 if(searchString!=''){
    ...
    return value.filter(it=>{  
        ...
        const subtaskName = (it.subtask_name!=''&&it.subtask_name!=null)?it.subtask_name.toLowerCase().toString().includes(searchString.toLowerCase()):false
        ...
        const milestName = (it.milestone_name!=''&&it.milestone_name!=null)?it.milestone_name.toLowerCase().toString().includes(searchString.toLowerCase()):false
