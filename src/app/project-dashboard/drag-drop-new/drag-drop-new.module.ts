...
import {DragDropNewRoutingModule } from './drag-drop-new-routing.module';
...
@NgModule({
    imports: [
        CommonModule,AccordionModule, MatButtonModule,
        MatButtonToggleModule,MatInputModule,MatSelectModule,MatIconModule,NgbModule,KanbanModule,MatExpansionModule,
        TranslateModule,ListViewModule,TabModule,DropDownListModule,MultiSelectModule,
        DragDropNewRoutingModule,MatGoogleMapsAutocompleteModule,AccumulationChartModule,GridAllModule,
    ...
    AgmCoreModule.forRoot({
      apiKey: 'AIzaSyDWYgdR81ZtTH4YBoAKDjbHRcKQJh2usCM',
      libraries: ['places']
    })
  ],
    declarations: [DragDropNewComponent],
    providers: [PieSeriesService, AccumulationLegendService, AccumulationTooltipService, AccumulationDataLabelService,
      AccumulationAnnotationService]
})
export class DragDropNewComponentModule {}
