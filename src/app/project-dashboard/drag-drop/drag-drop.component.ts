...
// };
  ...
  @ViewChild('kanbanObj',{static:true}) kanbanObj: KanbanComponent;
    ...
    public swimlaneSettings: SwimlaneSettingsModel = { keyField: 'task_name' };
    ...
    this.projectService.GetProjectActivityByProjectID(postData).subscribe(
      ...
      getAllTaskByActId(id){
       ...
       this.spinner.show();
          ...
          this.projectService.GetAllSubTaskByActivityID(postData).subscribe(
...
public updateStatus(args){
  ...
  let postData={
    ...
    "status_id": status_id,
     ...
     this.projectService.UpdateSubTaskStatus(postData).subscribe(
