...
import { AssigneeDragDropRoutingModule } from './assignee-drag-drop-routing.module';
...
@NgModule({
    imports: [
        ...
        AssigneeDragDropRoutingModule,MatGoogleMapsAutocompleteModule,AccumulationChartModule,GridAllModule,
