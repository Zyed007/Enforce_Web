...
public onAddSubmit(){
  ...
  let postData={
    ...
    feature_name: this.priorityForm.get('priorityName').value  ,
    feature_desc: this.priorityForm.get('desc').value,
     ...
     if(this.priorityForm.get('priorityName').value!='' && this.priorityForm.get('planName').value!='' ){
      ...
      return this.subscribeService.AddPlanFeature(postData).subscribe(
        (data:any)  => {
    ...
    public  getAllPriority(){
      this.subscribeService.getAllPriority().subscribe(
        ...
        this.showAddForm=true;
          ...
          this.subscribeService.FindByPlanFeatureID(postData).subscribe(
            (data:any)  => {
             ...
             let postData={
              ...
              this.priorityForm.patchValue({
                ...
                priorityName: data.feature_name,
    ...
    plan_id: this.planValue,
            ...
            feature_desc: this.priorityForm.get('desc').value,
              ...
              if (this.priorityForm.get('priorityName').value !== '') {
                  ...
                  return this.subscribeService.UpdatePlanFeature(postData).subscribe(
                    (data:any)  => {
                      // let dataObj = JSON.parse(data['token']);
        ...
        public taskDelete(deptId){
          ...
          this.subscribeService.RemovePlanFeature(postData).subscribe(
            (data:any)  => {
              // let dataObj = JSON.parse(data['token']);
